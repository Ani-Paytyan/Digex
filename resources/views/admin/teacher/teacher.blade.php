              ...
              <div class="card-body px-0 pb-2">
                  <div class="table-responsive p-0">
                      <div style ='float:right;padding: 2px 15px'>
                          <a href="{{url('admin/teacher/createTeacher')}}"><img src="https://img.icons8.com/material-rounded/48/fa314a/add.png"/></a>
                      </div>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                          <a href="{{url('/admin/teacher/edit/'.$teacher->id)}}" title="edit icons"><img src="https://img.icons8.com/material-outlined/24/000000/edit--v1.png"/></a>
                                          <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">

                                          </a>
                                          <form method="post" action="{{url('/admin/teacher/delete/'.$teacher->id)}}">
                                              {{ csrf_field()}}
                                                  @method('DELETE')
