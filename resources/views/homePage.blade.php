@extends('layouts/layoutHome')
    @section('content')
        <section class="slick-slideshow">
            ...
            <div class="slick-custom">
                <img src="{{URL::asset('img/homePage/images/slideshow/chess3.jpeg')}}" class="img-fluid" alt="">
    ...
    {{--                                    <a href="{{route('login')}}" class="btn custom-btn">Log in as teacher</a>--}}
            ...
            <div class="slick-custom">
                <img src="{{URL::asset('img/homePage/images/slideshow/chess2.jpeg')}}" class="img-fluid" alt="">
                <div class="slick-bottom">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-10">
            ...
            <div class="slick-custom">
                <img src="{{URL::asset('img/homePage/images/slideshow/chess1.jpeg')}}" class="img-fluid" alt="">
...
{{--                        <img src="{{URL::asset('img/homePage/images/chess.jpg')}}" alt="">--}}
{{--                    </div>--}}
