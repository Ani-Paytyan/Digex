...
{{--        <link href="css/bootstrap-icons.css" rel="stylesheet">--}}
        <link href="{{URL::asset('css/homePage/css/bootstrap-icons.css"')}}" rel="stylesheet">
        ...
        <main>
            ...
            <section class="slick-slideshow">
                <div class="slick-custom">
                    <img src="{{URL::asset('img/homePage/images/slideshow/medium-shot-business-women-high-five.jpeg')}}" class="img-fluid" alt="">
...
{{--                                    <a href="{{route('login')}}" class="btn custom-btn">Log in as teacher</a>--}}
                                    <a href="{{route('login')}}" class="btn custom-btn">Log in</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slick-custom">
                    <img src="{{URL::asset('img/homePage/images/slideshow/team-meeting-renewable-energy-project.jpeg')}}" class="img-fluid" alt="">
                    <div class="slick-bottom">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                ...
                <div class="slick-custom">
                    <img src="{{URL::asset('img/homePage/images/slideshow/two-business-partners-working-together-office-computer.jpeg')}}" class="img-fluid" alt="">
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="{{URL::asset('img/homePage/images/pim-chu-z6NZ76_UTDI-unsplash.jpeg')}}" class="img-fluid" alt="">
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="{{URL::asset('img/homePage/images/retail-shop-owner-mask-social-distancing-shopping.jpg')}}" alt="">
                        </div>
